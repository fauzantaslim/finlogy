...
@section('content')
    ...
    <article class="mx-auto w-full max-w-4xl pb-24">
        ...
        <header class="mb-12 border-b-2 border-[var(--color-bg-secondary)] pb-8">
            <h1 class="text-4xl font-black leading-tight tracking-tight text-[var(--color-text-primary)] md:text-5xl">Terms and Conditions</h1>
            <p class="mt-4 text-sm font-semibold text-[var(--color-text-secondary)] opacity-60">Last updated: April 21, 2026</p>
        </header>
